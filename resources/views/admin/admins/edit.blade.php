            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card card-with-nav">
                        <form method="post" action="/admins/{{ $admin->id }}" enctype="multipart/form-data"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="text" class="form-control  @error('name') is-invalid @enderror"
                                                ...
                                                value="{{ old('name', $admin->name) }}" autofocus required>
                                            @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="text" class="form-control @error('nik') is-invalid @enderror"
                                                ...
                                                value="{{ old('name', $admin->nik) }}" required>
                                            @error('nik')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="number" class="form-control @error('umur') is-invalid @enderror"
                                                value="{{ old('umur', $admin->umur) }}" name="umur" id="umur"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('pekerjaan', $admin->pekerjaan) }}" required>
                                            @error('umur')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="row mt-3 mb-1">
                                    <div class="col-md-12">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="text"
                                                class="form-control @error('pekerjaan') is-invalid @enderror"
                                                value="{{ old('alamat', $admin->alamat) }}" name="alamat"
